...
!(function () {
    ...
    (function () {
        ...
        (function (e, t, r) {
            ...
            function (e, t) {
                var r =
                        ...
                        "vertical" ===
                            JSON.parse(t.dataset.carouselOptions).axis
                            ? [
                    ...
                    !(function (c) {
                        ...
                        if (e && "" !== e) {
                            var r = JSON.parse(e),
                                ...
                                i = r.markers,
                                d = L.map(u[c], { scrollWheelZoom: e }).setView(
                                    n,
                                    o
                                );
                            if (
        ...
        (function () {
            for (
                var e = document.querySelectorAll("[data-bs-toggle-class]"),
                    t = 0;
                t < e.length;
                t++
            )
